...
const Footer = () => {
    ...
    return (
        <div className={'w-full bg-gray-900'}>
            <Background color="bg-footer-bg-trimmed bg-no-repeat bg-cover rounded-t-md pt-10 mt-12">
                    <Section>
                        <div className={`md:flex ${AppConfig.text_primary_color} px-5 md:px-0`} id={'contact-us'}>
                            <div className={`text-md flex w-full items-center justify-center md:w-1/2 ${AppConfig.text_secondary_color}`}>
