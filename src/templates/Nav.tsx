    ...
    return (
        <div className="navbar bg-base-100 sticky top-0 z-[9999] shadow-sm">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        ...
                        <li><Link href={'/#event-description'}>{t('Nav.EventDescription')}</Link></li>
                        <li>
                            <Link  href={'/about'}>{t('Nav.About')}</Link >
                            <ul className="p-2">
                                <li><Link href={'#'}>{t('Nav.About.Speakers')}</Link></li>
                                <li><Link href={'#'}>{t('Nav.About.OrganizingCommittee')}</Link></li>
                                <li><Link href={'#'}>{t('Nav.About.ProgrammeBoard')}</Link></li>
                            </ul>
                        </li>
            ...
            <div className="navbar-end md:pr-5">
                <a className="btn">{t('Nav.Submit')}</a>
            </div>
        </div>
    )
}
