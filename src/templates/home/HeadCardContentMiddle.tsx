  ...
  return (
    <div className={"flex h-full text-center text-white max-sm:items-center"}>
      <div className={" w-full md:pt-40 lg:w-1/2 xl:w-4/6 xl:pl-24 xl:pr-12"}>
        ...
        >
          National Conference <br /> on <br />
          Applied Mathematics, <br /> Computer Science, Data analytics
          <br />
          <p className={`hidden text-xl max-sm:block xl:text-3xl ${AppConfig.text_secondary_color}`}>
            And Implications in <br/> Economic - Business
          </p>
          <p className={`block text-xl max-sm:hidden xl:text-3xl ${AppConfig.text_secondary_color}`}>
      ...
      <div className={"block pb-10 max-sm:hidden md:pr-24 md:pt-40 lg:w-1/2 xl:w-2/6"}>
        <div className={`flex-col items-center ${AppConfig.bg_dark} rounded-xl bg-opacity-70 p-5`}>
          ...
          <p className={"pt-2 text-lg font-bold"}>Conference participation registration</p>
          <p className={"text-lg font-normal"}>12/08/2025</p>
          <p className={"pt-2 text-lg font-bold"}>Conference day</p>
          <p className={"text-lg font-normal"}>16/08/2025</p>
        </div>
      </div>
    </div>
  );
